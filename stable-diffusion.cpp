        ...
        auto denoise = [&](ggml_tensor* input, float sigma, int step) -> ggml_tensor* {
            ...
            if (has_unconditioned || has_img_cond) {
                for (int i = 0; i < ne_elements; i++) {
                    ...
                    if (guidance.apg.norm_threshold > 0 || log_cfg_norm) {
                ...
                if (guidance.apg.norm_threshold > 0) {
                    ...
                    if (guidance.apg.norm_threshold_smoothing <= 0) {
                        ...
                        apg_scale_factor = x / std::pow(1 + std::pow(x, 1.0 / guidance.apg.norm_threshold_smoothing), guidance.apg.norm_threshold_smoothing);
                    }
                }
                if (guidance.apg.eta != 1.0f) {
...
void sd_sample_params_init(sd_sample_params_t* sample_params) {
    *sample_params                             = {};
    ...
    sample_params->guidance.apg.eta            = 1.0f;
